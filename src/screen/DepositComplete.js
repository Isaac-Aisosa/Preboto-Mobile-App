...
export default function DepositComplete({ navigation })
 {
       ...
       <Text style={{fontSize:25, marginTop:10, marginLeft:10,fontWeight:'bold', alignSelf:'center',color:'#000'}}>
        ...
        <Pressable style={{marginTop:20, borderRadius:5, width:'100%', height:100,backgroundColor:'#b3d9ff'}}>
         <Text style={{fontSize:14, marginTop:10, marginLeft:10,fontWeight:'normal', alignSelf:'center',color:'#000'}}>
            Your Account will be credited after payment is been VERIFIED by our Team.
          </Text>
          <Text style={{fontSize:14, marginTop:10, marginLeft:10,fontWeight:'normal', alignSelf:'center',color:'red'}}>
            Note: Normally take about 24hrs if you dont get credited after 24hrs contact Preboto
          </Text>
        </Pressable>
